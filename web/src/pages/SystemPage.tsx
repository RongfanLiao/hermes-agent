...
export default function SystemPage() {
  ...
  // Debug share (upload report + logs to a public paste service) is removed
  // in this fork — see the disabled /api/ops/debug-share route.
  ...
  const applyUpdate = async () => {
    ...
    if (status?.can_update_hermes === false) {
      showToast(
        "Briefing updates are managed outside this dashboard.",
        "success",
      );
      return;
    }
        ...
        <Card>
          <CardContent className="flex flex-col gap-4 py-4">
            ...
            <ConfirmDialog
              ...
              title="Restore full Briefing backup?"
              description={`This will overwrite your current Briefing configuration, skills, sessions, and data with the contents of ${backupImportLabel(importConfirmTarget)}. This cannot be undone.`}
              destructive
